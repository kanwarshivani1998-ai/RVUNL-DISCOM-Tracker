...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "मुख्य पृष्ठ — RVUNL/DISCOM Tracker" },
      { name: "description", content: "आपकी RVUNL/DISCOM परीक्षा तैयारी का समग्र सारांश — प्रगति, स्ट्रीक, और आज का लक्ष्य।" },
    ],
  }),
  component: Dashboard,
});
...
function Dashboard() {
  ...
  return (
    <AppShell title="मुख्य पृष्ठ" subtitle="RVUNL/DISCOM अध्ययन ट्रैकर">
      {/* Hero progress */}
      <motion.section
