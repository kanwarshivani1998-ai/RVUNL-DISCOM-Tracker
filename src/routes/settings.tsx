...
import { Bell, BookMarked, CalendarClock, ChevronRight, Clock, Download, Edit3, Moon, Repeat, StickyNote, Sun, Trash2, Upload, Monitor, BarChart3, RefreshCw, GraduationCap, Mail, Sparkles, FileText } from "lucide-react";
...
function SettingsPage() {
  ...
  const handleExport = async () => {
    ...
    a.href = url;
    a.download = `rvunl-tracker-${new Date().toISOString().slice(0,10)}.json`;
    a.click();
  ...
  const requestNotif = async () => {
    ...
    if (granted) {
      ...
      await fireNotification("RVUNL/DISCOM Tracker", "अधिसूचना सक्रिय — रोज़ाना अध्ययन याद रहे!");
    } else {
    ...
    <AppShell title="सेटिंग्स" subtitle="ऐप को अपने अनुसार सेट करें">
      <div className="space-y-4">
        ...
        <Section title="त्वरित पहुँच">
          <LinkRow to="/exam-syllabus" icon={FileText} label="RVUNL / जूनियर असिस्टेंट भर्ती सिलेबस" />
