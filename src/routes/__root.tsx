...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "RVUNL Tracker" },
      { title: "RVUNL/DISCOM Junior Assistant Tracker — RVUNL/DISCOM जूनियर असिस्टेंट तैयारी" },
      { name: "description", content: "RVUNL/DISCOM जूनियर असिस्टेंट भर्ती परीक्षा के लिए हिंदी में ऑफलाइन अध्ययन ट्रैकर — पाठ्यक्रम, प्रगति, रिवीजन और सांख्यिकी।" },
      { name: "author", content: "RVUNL/DISCOM Tracker" },
      { property: "og:title", content: "RVUNL/DISCOM Junior Assistant Tracker" },
      { property: "og:description", content: "RVUNL/DISCOM जूनियर असिस्टेंट की तैयारी के लिए हिंदी ऑफलाइन ट्रैकर।" },
